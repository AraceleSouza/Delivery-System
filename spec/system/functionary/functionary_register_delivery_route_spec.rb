...
describe 'Functionary register delivery route' do
  ...
  it 'with incomplete data' do
    ...
    fill_in 'Endereço atual', with: ''
    fill_in 'Data', with: ''
    click_on 'Gravar'
    # Assert
    expect(page).to have_content "Rota não cadastrada."
    expect(page).to have_content "Endereço de saída não pode ficar em branco" 
    expect(page).to have_content "Endereço atual não pode ficar em branco"
